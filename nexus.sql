...
CREATE TABLE `equipos` (
  ...
  CONSTRAINT `fk_Equipos_Imagenes1` FOREIGN KEY (`idImagenes`) REFERENCES `imagenes` (`idImagenes`),
...
CREATE TABLE `formularios` (
  ...
  CONSTRAINT `fk_Formularios_Imagenes1` FOREIGN KEY (`idImagenesForm`) REFERENCES `imagenes` (`idImagenes`),
...
CREATE TABLE `tickets` (
  ...
  `latitud` decimal(12,0) DEFAULT NULL,
  `longitud` decimal(12,0) DEFAULT NULL,
  `descripcion` varchar(45) NOT NULL,
  `estado` int NOT NULL,
  ...
  CONSTRAINT `fk_Tickets_Imagenes1` FOREIGN KEY (`idImagenTicket`) REFERENCES `imagenes` (`idImagenes`),
...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `fk_Usuarios_Imagenes1` FOREIGN KEY (`idImagenPerfil`) REFERENCES `imagenes` (`idImagenes`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-01 11:02:40
